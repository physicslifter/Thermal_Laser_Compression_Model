...
thermalBC(thermalmodelT,'Edge',43,'Temperature',@BC_external_exp2); %8, 12
thermalBC(thermalmodelT,'Edge',44,'Temperature',@BC_external_exp2); %9, 13
thermalBC(thermalmodelT,'Edge',45,'Temperature',@BC_external_exp2); %10, 14

thermalBC(thermalmodelT,'Edge',46,'Temperature',@BC_external_exp2); %8, 12
thermalBC(thermalmodelT,'Edge',47,'Temperature',@BC_external_exp2); %9, 13
thermalBC(thermalmodelT,'Edge',48,'Temperature',@BC_external_exp2); %10, 14

thermalBC(thermalmodelT,'Edge',49,'Temperature',@BC_external_exp2); %8, 12
thermalBC(thermalmodelT,'Edge',50,'Temperature',@BC_external_exp2); %9, 13
thermalBC(thermalmodelT,'Edge',51,'Temperature',@BC_external_exp2); %10, 14
...
figure
ax1=axes('Position',[0.13,0.11,0.85,0.69]);
plot(t_data1_80,temp1_80,'o',t_data2_80,temp2_80,'o',t_data3_80,temp3_80,'o',...
