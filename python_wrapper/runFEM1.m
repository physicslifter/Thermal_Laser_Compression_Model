%Pat - based off of Tyler's code: heat_equation_data_1D_exp.m
%The above code can be found in the main folder, compare for differences

%=================================================================================
%Putting in the code for reading in the file data
%from fitting_data_73ref.m
...
save('FEM_output/1D_run_output.mat','tlist','T11','T12','T13','t_data','temp1_corrected', 'temp2_corrected','temp3_corrected')
