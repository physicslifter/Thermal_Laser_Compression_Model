...
input_parameter_file="standard_input.mat";
...
if square==true
    ...
    thermalBC(thermalmodelT,'Edge',51,'Temperature',@BC2); %8, 12
    thermalBC(thermalmodelT,'Edge',52,'Temperature',@BC2); %9, 13
    thermalBC(thermalmodelT,'Edge',53,'Temperature',@BC2); %10, 14

    thermalBC(thermalmodelT,'Edge',54,'Temperature',@BC2); %8, 12
    thermalBC(thermalmodelT,'Edge',55,'Temperature',@BC2); %9, 13
    thermalBC(thermalmodelT,'Edge',56,'Temperature',@BC2); %10, 14

    thermalBC(thermalmodelT,'Edge',57,'Temperature',@BC2); %8, 12
    thermalBC(thermalmodelT,'Edge',58,'Temperature',@BC2); %9, 13
    thermalBC(thermalmodelT,'Edge',59,'Temperature',@BC2); %10, 14
    
    thermalBC(thermalmodelT,'Edge',60,'Temperature',@BC2); %8, 12
    thermalBC(thermalmodelT,'Edge',61,'Temperature',@BC2); %9, 13
    thermalBC(thermalmodelT,'Edge',62,'Temperature',@BC2); %10, 14
else
    thermalIC(thermalmodelT,t0);             
