...
input_parameter_file="1d_combined_input_matrixs2.mat";
...
if square==true
    ...
    thermalBC(thermalmodelT,'Edge',51,'Temperature',@BCs2); %8, 12
    thermalBC(thermalmodelT,'Edge',52,'Temperature',@BCs2); %9, 13
    thermalBC(thermalmodelT,'Edge',53,'Temperature',@BCs2); %10, 14

    thermalBC(thermalmodelT,'Edge',54,'Temperature',@BCs2); %8, 12
    thermalBC(thermalmodelT,'Edge',55,'Temperature',@BCs2); %9, 13
    thermalBC(thermalmodelT,'Edge',56,'Temperature',@BCs2); %10, 14

    thermalBC(thermalmodelT,'Edge',57,'Temperature',@BCs2); %8, 12
    thermalBC(thermalmodelT,'Edge',58,'Temperature',@BCs2); %9, 13
    thermalBC(thermalmodelT,'Edge',59,'Temperature',@BCs2); %10, 14
    
    thermalBC(thermalmodelT,'Edge',60,'Temperature',@BCs2); %8, 12
    thermalBC(thermalmodelT,'Edge',61,'Temperature',@BCs2); %9, 13
    thermalBC(thermalmodelT,'Edge',62,'Temperature',@BCs2); %10, 14
else
    thermalIC(thermalmodelT,t0);             
    thermalBC(thermalmodelT,'Edge',51,'Temperature',@BCs2); %8, 12
    thermalBC(thermalmodelT,'Edge',52,'Temperature',@BCs2); %9, 13
...
xw = 1; %throughput correction based on slit width and shot number
aeta=25.5; %1/delta_t of SOP data, was 46
a0_76=395900;% Based on ND filter of 0 (481000) (395900)
t0a_76=1.91;% Based on ND filter of 0 (1.909) (1.91)
