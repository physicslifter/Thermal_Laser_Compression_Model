...
my_group=main.OptimizationGroup(60, run_dict, 'Eq1_73&76&80', my_data, equation=1)
a=main.optimize(my_group, opt_output_data, eq1_bounds, 10, equation=1)

#%%
import main
#Run end of optimization operations
q=main.PostOptOperations('../../winhome/Desktop/optimization_data/20220415/Eq1_73&76&80')
