...
namespace dolfin
{
  class dolfin_expression_939d7866a1e13e34821984a05b22d04d : public Expression
  {
     public:
       double tol;
double k_1;
...
double l;
       ...
       dolfin_expression_939d7866a1e13e34821984a05b22d04d()
       {
       ...
       void eval(Eigen::Ref<Eigen::VectorXd> values, Eigen::Ref<const Eigen::VectorXd> x) const override
       {
          ...
          values[0] = x[0] <= l + tol ? b+a*u+c*u2 : k_1;
...
extern "C" DLL_EXPORT dolfin::Expression * create_dolfin_expression_939d7866a1e13e34821984a05b22d04d()
{
  return new dolfin::dolfin_expression_939d7866a1e13e34821984a05b22d04d;
}
